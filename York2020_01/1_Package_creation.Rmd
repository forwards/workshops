...
```
.footnote[
[1] If the Git pane does not open, try closing the project and reopening by navigating to it without using the windows shortcuts.
]
---
# Create your first package.
...
You will find "Review Changes" window is now empty because everything is up-to-date.
