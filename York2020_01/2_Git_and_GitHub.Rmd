...
`use_github()` requires that your project already be a Git repository, which you can accomplish with `use_git()`<sup>1</sup>.


.footnote[
[1] We used `use_git()` in [Package creation ](1_Package_creation.html).
]
...
ea7bb1945caa9922aacabee66b0fa2609f848677

then do as instructed
> usethis::edit_r_environ()

GITHUB_PAT=ea7bb1945caa9922aacabee66b0fa2609f848677

● Modify '//userfs/er13/w2k/.Renviron'
● Restart R for changes to take effect

Make sure you restart R, then do use_github() again
