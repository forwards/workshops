...
We are going to write a package called `mypackage` has some simple utilities for a single large function. It will calculate the mean, sums of squares and standard deviation, carry out a one-sample z-test and create a couple of figures.
