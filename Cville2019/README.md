...
There is a completed sample package you can use as reference in the afternoon session - you can see it [here!](https://github.com/forwards/workshops/tree/master/Cville2019/demoPackage)
