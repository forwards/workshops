...
institute: '<br>`r icon::fa("twitter")` [\@R_Forwards](https://twitter.com/R_Forwards)<br>`r icon::fa("link")` https://forwards.github.io/edu/workshops/zero-to-hero'
...
library(rio)
infant <- import("../workshop materials/infant/infant.xlsx", setclass = "tibble")
```
